/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: c16c8739a33fd867e5eaf51aa3a7379a)
// Runtime types generated with workerd@1.20260811.1 2026-08-05 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	YOUCAM_USER_RATE_LIMITER: RateLimit;
	YOUCAM_SITE_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	BEAUTYPROOF_SESSION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BEAUTYPROOF_SESSION_SECRET" | "NEXT_PUBLIC_APP_URL" | "SUPABASE_SECRET_KEY" | "SUPABASE_URL" | "YOUCAM_API_KEY">> {}
}
